...
def multiples_of_ten(start: int, stop: int) -> Tensor:
    ...
    ##########################################################################
    # Replace "pass" statement with your code
    list = [x for x in range(start, stop+1) if (x % 10 == 0)]
...
def slice_indexing_practice(x: Tensor) -> Tuple[Tensor, Tensor, Tensor, Tensor]:
    ...
    rows = [i for i in range(x.shape[0]) if i % 2 == 0]
    cols = [i for i in range(x.shape[1]) if i % 2 == 1]
    even_rows_odd_cols =  x[rows,:]
    even_rows_odd_cols = even_rows_odd_cols[:, cols]
    ##########################################################################
    #                            END OF YOUR CODE                            #
    ##########################################################################
    out = (
...
def reverse_rows(x: Tensor) -> Tensor:
    ...
    ##########################################################################
    # Replace "pass" statement with your code
    ls = [i for i in range(x.shape[0] - 1,-1 , -1)]
    print(ls)
    y = x[ls]
    ##########################################################################
    #                            END OF YOUR CODE                            #
